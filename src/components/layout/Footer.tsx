...
//   { value: "research",  label: "Research & Assessment" },
//   { value: "rep",       label: "In-Country Representation" },
//   { value: "collab",    label: "Academic Collaborations" },
//   { value: "comply",    label: "Admissions Compliance" },
//   { value: "marketing", label: "Strategic Marketing" },
//   { value: "ops",       label: "Operational Support" },
...
//   // ── Trigger label: show all selected names comma-separated ──
//   const servicesLabel =
...
//         <div className="relative -top-10 bg-white text-black rounded-3xl border px-5 sm:px-8 lg:px-14 py-6 flex flex-col lg:flex-row items-center lg:items-center justify-between gap-5 max-w-5xl mx-auto">
...
//               required
//               className="w-full sm:w-64 md:w-72 lg:w-80 border border-gray-300 sm:border-r-0 rounded-lg sm:rounded-l-lg sm:rounded-r-none px-5 py-3 text-sm text-gray-700 focus:outline-none"
//             />
//             <button
//               type="submit"
//               className="bg-red-600 hover:bg-red-700 transition text-white text-sm font-bold px-6 py-3 rounded-lg sm:rounded-l-none sm:rounded-r-lg whitespace-nowrap"
//             >
//               Subscribe Now
//             </button>
//           </form>
...
//                       <input type="text"  name="fullName"     placeholder="Full Name"   className={inputClass} required />
//                       <input type="email" name="email"        placeholder="Email ID"    className={inputClass} required />
//                     </div>

//                     <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
//                       <input type="text" name="designation"  placeholder="Designation"  className={inputClass} />
//                       <input type="text" name="organisation" placeholder="Organisation" className={inputClass} />
//                     </div>
...
//                       >
//                         <span
//                           className={`truncate ${selectedServices.length === 0 ? "text-gray-400" : "text-white"}`}
//                         >
//                           {servicesLabel}
//                         </span>
//                         <svg
...
//                     <textarea name="message" rows={5} placeholder="Message" className={`${inputClass} resize-none`} />
