  ...
  return (
    <div className="group flex flex-col bg-white border border-gray-200 rounded-xl overflow-hidden hover:-translate-y-2 transition-shadow duration-300">
      ...
      <div className="px-5 pt-2">
        <h3 className="text-[15px] font-bold text-red-700 line-clamp-2">
          {item.title}
        </h3>
      </div>
...
export default function Page() {
  ...
  if (error) {
    return <p className="text-center py-20">Error loading events</p>;
  }

  // Convert Payload CMS data
        ...
        <div className="relative w-full h-80 overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center">
            <div className="max-w-7xl mx-auto w-full px-6">
              <h1 className="text-white font-extrabold text-5xl mt-20">
                Events
              </h1>
            </div>
          </div>
