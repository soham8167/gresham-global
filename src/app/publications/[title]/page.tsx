    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center space-y-3">
          ...
          <p className="text-gray-500 text-sm">Loading publication...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="bg-white min-h-screen">
      ...
      {data?.details?.length > 0 && (
        <div
          ...
          style={{ background: "linear-gradient(135deg, #e8e8e8 0%, #f5f5f5 50%, #e0e0e0 100%)" }}
        >
          <div className="max-w-5xl mx-auto px-4 sm:px-6 md:px-10 lg:px-12">
            ...
            <div className="hidden md:block">
              <div className="relative flex items-start justify-between gap-4">
                <div
                  className="absolute top-[48px] left-[calc(100%/6)] right-[calc(100%/6)]"
                  style={{ borderTop: "2px dashed #aaa", zIndex: 0 }}
                />
                {data.details.map((item: any, i: number) => (
                  <div key={i} className="relative flex flex-col items-center flex-1 z-10">
                    <div className="relative w-20 h-20 lg:w-24 lg:h-24 rounded-full bg-gradient-to-br from-red-500 to-red-700 shadow-lg flex items-center justify-center ring-4 ring-white">
                    ...
                    <div className="flex flex-col items-center mt-1">
                      <div style={{ borderLeft: "2px dashed #aaa", height: "24px" }} />
                    ...
                    <p className="text-center text-gray-700 text-xs lg:text-sm leading-relaxed mt-3 max-w-[160px] lg:max-w-[180px]">
                      {item.description}
                    </p>
                  </div>
                ))}
            ...
            <div className="md:hidden flex flex-col gap-8">
              {data.details.map((item: any, i: number) => (
                <div key={i} className="flex gap-5 items-start">
                  <div className="relative shrink-0 w-16 h-16 rounded-full bg-gradient-to-br from-red-500 to-red-700 shadow-lg flex items-center justify-center ring-4 ring-white">
                    {item.detailImage?.url && (
                      <Image
                        src={item.detailImage.url}
                        alt="highlight icon"
      ...
      {similar.length > 0 && (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 lg:px-12 py-12 md:py-16">
          <h2 className="text-xl sm:text-2xl font-bold mb-6 md:mb-8">Similar Publications</h2>
