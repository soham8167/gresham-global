    ...
    <section className="w-full overflow-x-hidden">
      ...
      <div className="relative w-full h-48 sm:h-64 md:h-80 lg:h-96 overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="w-full px-4 sm:px-6 md:px-12 max-w-7xl mx-auto">
            <h1 className="text-white font-bold text-3xl sm:text-5xl md:text-6xl lg:text-7xl">
              About Us
            </h1>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="flex justify-center md:justify-start">
              <Image
                ...
                height={520}
                priority
                className="object-contain w-full max-w-xs sm:max-w-sm md:max-w-full"
              />
            </div>
      ...
      <div className="w-full bg-white py-16 md:py-20 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-center text-gray-900 mb-10 md:mb-14">
            Our Founders
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            ...
            {/* Founder Card 1 */}
            <div className="bg-white rounded-2xl shadow-md p-6 sm:p-8 flex flex-col sm:flex-row gap-6 items-start w-full">
              <div className="flex flex-col items-center sm:items-start shrink-0">
                <div className="w-28 h-32 sm:w-36 sm:h-40 rounded-xl overflow-hidden">
                  <Image
                    src="/images/about/Group1.webp"
                    alt="Jaspreet Singh"
                    width={144}
