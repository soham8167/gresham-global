      ...
      <div className="w-full bg-white py-10 md:py-14 lg:py-16 px-6 md:px-12">
        <div className="max-w-8xl mx-auto text-center">
          <h2 className="font-extrabold text-black text-3xl sm:text-4xl md:text-[2.6rem] lg:text-6xl leading-tight mb-5">
            Upholding Your University’s Admissions Standards
          </h2>
          <p className="text-gray-600 text-base sm:text-lg leading-relaxed max-w-5xl mx-auto">
            Managing admissions and ensuring compliance is pivotal to a successful international student recruitment strategy. 
            At Gresham Global, we simplify these complex processes, safeguarding your institution’s credibility
             while delivering a seamless experience for students and stakeholders.
          </p>
        </div>
      </div>
