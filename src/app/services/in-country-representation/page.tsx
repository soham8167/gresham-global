      ...
      <div className="w-full bg-white py-10 md:py-14 lg:py-16 px-6 md:px-12">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="font-extrabold text-black text-3xl sm:text-4xl md:text-[2.6rem] leading-tight mb-5">
            Empowering your University & Future, Today
          </h2>
          <p className="text-gray-600 text-base sm:text-lg leading-relaxed max-w-3xl mx-auto">
            India and South Asia & vast and diverse landscape presents immense opportunities for international universities seeking to expand their footprint. We offer tailored research and assessment solutions designed to ensure your institution & growth is both impactful and long-term.
          </p>
        </div>
      </div>
      ...
      <div className="w-full bg-white pb-14 md:pb-20 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          {serviceCards.map(({ icon, title, description }) => (
            <div key={title} className="rounded-2xl border border-[#C0193A]/30 bg-white p-7 sm:p-9 flex flex-col gap-5 transition-shadow duration-300 hover:shadow-[0_4px_32px_0_rgba(192,25,58,0.12)]">
