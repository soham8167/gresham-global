      ...
      <div className="w-full bg-white py-10 md:py-14 lg:py-16 px-6 md:px-12">
        <div className="max-w-8xl mx-auto text-center">
          ...
          <p className="text-gray-600 text-base sm:text-lg leading-relaxed max-w-5xl mx-auto">
           Expanding your university’s reach demands a strategy that resonates with the region’s distinct dynamics. 
           We deliver tailored marketing solutions
            that increase visibility, build strong relationships, and drive long-term success across diverse markets.
          </p>
        </div>
      </div>
